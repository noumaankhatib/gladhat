...
export const PORTFOLIO_STORIES = [
  {
    ...
    img: assetUrl('/images/logos/server_factory.png'),
    cover: assetUrl('/images/epic_founders.png'),
  ...
  },
  {
    ...
    img: assetUrl('/images/logos/first_light.png'),
    cover: assetUrl('/images/epic_essence.png'),
    categories: ['brand'],
    categoryLabel: 'Brand',
  ...
  },
  {
    ...
    img: assetUrl('/images/logos/tonbo.png'),
    cover: assetUrl('/images/epic_connecting.png'),
  ...
  },
  {
    ...
    img: assetUrl('/images/logos/ensights.png'),
    cover: assetUrl('/images/epic_beyond.png'),
  ...
  },
  {
    ...
    img: assetUrl('/images/logos/provengo.svg'),
    cover: assetUrl('/images/epic_curiosity.png'),
